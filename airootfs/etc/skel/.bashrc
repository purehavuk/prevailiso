# BestBASH by Jaivardhan Kapoor <https://github.com/jaivardhankapoor>
...
rdep() {
  unnecessary=$(paru -Qdtq)
  paru -Rns $unnecessary --noconfirm
}

alias updateall='paru -Syy && paru -Syu --noconfirm --skipreview' # Easy updating...mostly because I'm lazy
#}}}
...
# LOCALE{{{
if [ ! -f $HOME/.locale.conf ]; then
  while IFS='=' read -r key value; do
    case "$key" in
      LANG|LC_ALL|LC_NUMERIC|LC_ADDRESS|LC_COLLATE|LC_MONETARY|LC_TIME|LC_TELEPHONE|LC_MEASUREMENT|LC_PAPER|LC_NAME|LC_CTYPE|LC_IDENTIFICATION|LC_LARGE_NUMERIC|LC_MESSAGES|LC_SEARCH)
        export "$key=$value"
        ;;
    esac
...
#Python
WORKON_HOME=~/.pyenv
PYENVW=$(which virtualenvwrapper.sh)

if [ ! -d "$HOME/.pyenv" ]; then
  echo -e '\e[1;38;5;214mCreating Python virtual environment at '"'$HOME/.pyenv'"'...\e[0m'
